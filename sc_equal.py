...
print"\n****Subsets Formation*******\n"
data1 = training.loc[training['label'] == '1']
data2 = training.loc[training['label'] == '2']
data3 = training.loc[training['label'] == '3']
data4 = training.loc[training['label'] == '4']
data5 = training.loc[training['label'] == '5']
...
subset1 = subset1.append(data4)
subset2 = subset2.append(data4)
subset3 = subset3.append(data4)
subset4 = subset4.append(data4)
subset5 = subset5.append(data4)
subset6 = subset6.append(data4)
subset7 = subset7.append(data4)
subset8 = subset8.append(data4)
subset9 = subset9.append(data4)
subset10 = subset10.append(data4)

subset1 = subset1.append(data3)
subset2 = subset2.append(data3)
subset3 = subset3.append(data3)
subset4 = subset4.append(data3)
subset5 = subset5.append(data3)
subset6 = subset6.append(data3)
subset7 = subset7.append(data3)
subset8 = subset8.append(data3)
subset9 = subset9.append(data3)
subset10 = subset10.append(data3)

subset1 = subset1.append(data2[0:20000])
subset2 = subset2.append(data2[20000:40000])
subset3 = subset3.append(data2[40000:60000])
subset4 = subset4.append(data2[60000:80000])
subset5 = subset5.append(data2[10000:30000])
subset6 = subset6.append(data2[30000:50000])
subset7 = subset7.append(data2[50000:70000])
subset8 = subset8.append(data2[70000:90000])
subset9 = subset9.append(data2[10000:30000])
subset10 = subset10.append(data2[55000:75000])

subset1 = subset1.append(data1[0:25000])
subset2 = subset2.append(data1[30000:55000])
subset3 = subset3.append(data1[60000:85000])
subset4 = subset4.append(data1[90000:115000])
subset5 = subset5.append(data1[120000:145000])
subset6 = subset6.append(data1[150000:175000])
subset7 = subset7.append(data1[180000:205000])
subset8 = subset8.append(data1[210000:235000])
subset9 = subset9.append(data1[240000:265000])
subset10 = subset10.append(data1[270000:295000])

subset1_features = subset1[num_features]
subset1_label = subset1['label']

subset2_features = subset2[num_features]
subset2_label = subset2['label']

subset3_features = subset3[num_features]
subset3_label = subset3['label']

subset4_features = subset4[num_features]
subset4_label = subset4['label']

subset5_features = subset5[num_features]
subset5_label = subset5['label']

subset6_features = subset6[num_features]
subset6_label = subset6['label']

subset7_features = subset7[num_features]
subset7_label = subset7['label']

subset8_features = subset8[num_features]
subset8_label = subset8['label']

subset9_features = subset9[num_features]
subset9_label = subset9['label']

subset10_features = subset10[num_features]
subset10_label = subset10['label']
