...
subset3 = training.sample(frac=0.1)
subset4 = training.sample(frac=0.1)
subset5 = training.sample(frac=0.1)
subset6 = training.sample(frac=0.1)
subset7 = training.sample(frac=0.1)
subset8 = training.sample(frac=0.1)
subset9 = training.sample(frac=0.1)
subset10 = training.sample(frac=0.1)
